...
class GradeStatisticsGraphViewTests: XCTestCase {
    ...
    private func validateLayout(assignment: Assignment, allowedError: CGFloat) {
        ...
        // Check labels
        let x1 = view.minPossibleLabel.frame.midX, x2 = view.minLabel.frame.midX, x3 = view.averageLabel.frame.midX, x4 = view.maxLabel.frame.midX, x5 = view.maxPossibleLabel.frame.midX
    ...
    func updateAndValidateLayoutForAssignment(assignment: Assignment, allowedError: CGFloat = 20.0) {
        view.layoutIfNeeded()
    ...
    func testLabelsCorrectLocationNoPressure() {
        ...
        updateAndValidateLayoutForAssignment(assignment: a, allowedError: 2.0)
    }
    ...
    func testLabelsCorrectLocationAllZero() {
        ...
        updateAndValidateLayoutForAssignment(assignment: a, allowedError: 70.0)
    }
    ...
    func testLabelsCorrectLocationFullSplit() {
        ...
        updateAndValidateLayoutForAssignment(assignment: a, allowedError: 40.0)
    }
    ...
    func testLabelsOutOfBounds() {
        ...
        validateLayout(assignment: lookalike, allowedError: 50.0)
    }
    ...
    func testLabelsCorrectText() {
        ...
        view.update(a)
        XCTAssertEqual(view.minPossibleLabel.text, "0")
        XCTAssertEqual(view.minLabel.text, "MIN\n2.0")
        XCTAssertEqual(view.maxLabel.text, "MAX\n8.0")
        XCTAssertEqual(view.maxPossibleLabel.text, "10")
    }
}
